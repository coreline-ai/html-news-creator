...
`html-news-creator`는 매일 50+ 소스에서 AI 트렌드를 수집해 **에디토리얼 톤의 HTML 리포트**를 생성하는 파이프라인입니다. 도메인 특성상 모노크롬 에디토리얼 DNA가 거의 그대로 적용 가능합니다.
...
| Density | 워크스페이스 고밀도 | 리포트는 **여유**, 운영 화면은 고밀도 | 독자 경험 vs 운영자 효율 |
