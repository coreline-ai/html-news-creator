...
class Settings(BaseSettings):
    ...
    # Full runs can spend 12–20+ minutes in classify/verify/generate when the
    ...
    admin_run_default_max_runtime_sec: int = 3600
    admin_allow_llm_fallback_on_proxy_down: bool = True
